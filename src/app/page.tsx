...
const perks = [
    ...
    },
    {
        ...
        Icon: CheckCircle,
        description:
            '\'Every asset on our platform is verified by our team to ensure our highest quality standards. Not happy? We offer a 30-day refund g'
    },
    {
        name: 'For the Planet',
        Icon: Leaf,
...
export default function Home() {
  return (
      <>
 <MaxWithWrapper>
   <div className="py-20 mx-auto text-center flex flex-col
              ...
              {perks.map((perk) => (
                  <div key={perk.name}
                   className="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
                      ...
                      <div className="mt-6 md:ml-4 md:mt-0.5 lg:ml-0 lg:mt-6">
